...
import com.example.loginauth.AccessFilter;
...
public class SpringcloudLearnConsume2ZuulApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringcloudLearnConsume2ZuulApplication.class, args);
	}
